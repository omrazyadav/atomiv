...
export default function CreateDemoPage() {
  ...
  const handleTemplateSelect = (templateId: string) => {
    ...
    if (template && template.template_data) {
      setFormData(prev => ({
        ...prev,
        heroTitle: template.template_data.hero_title || '',
        heroSubtitle: template.template_data.hero_subtitle || '',
        features: template.template_data.features || [],
        primaryColor: template.template_data.primary_color || '#3b82f6',
        secondaryColor: template.template_data.secondary_color || '#8b5cf6'
      }))
  ...
  const handleSubmit = async (status: 'draft' | 'active') => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error('Failed to create demo page:', errorData)
        alert('Failed to create demo page: ' + (errorData.error || 'Unknown error'))
      }
    } catch (error) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Create Demo Page</h1>
              <p className="text-gray-400 mt-1">Build a custom demo experience for your client</p>
            </div>
          </div>
