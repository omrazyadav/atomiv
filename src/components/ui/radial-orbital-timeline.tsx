...
export default function RadialOrbitalTimeline({
  ...
  const calculateNodePosition = (index: number, total: number) => {
    if (!mounted) {
      return { x: 0, y: 0, angle: 0, zIndex: 100, opacity: 0.5 };
    }
  ...
  if (!mounted) {
    return (
      <div className="w-full h-[600px] flex flex-col items-center justify-center bg-transparent relative">
  ...
  return (
    <div
      className="w-full h-[600px] flex flex-col items-center justify-center bg-transparent relative"
      ref={containerRef}
